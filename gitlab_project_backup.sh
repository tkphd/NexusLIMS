...
PROJECT_URL="https://gitlab.nist.gov/api/v4/projects/676"
...
function added_help {
    ...
    echo ""
    echo "    https://gitlab.nist.gov/gitlab/profile/personal_access_tokens"
    echo ""
}
  ...
  do
    case "$optname" in
      ...
      ":")
        ...
        ;;
      *)
        echo "***REMOVED*** error while processing options"
        exit 0;
        ;;
    esac
  done
