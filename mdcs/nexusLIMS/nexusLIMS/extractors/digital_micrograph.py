...
def parse_643_titan(mdict):
    """
    Add/adjust metadata specific to the 643 FEI Titan ('***REMOVED***
...
def parse_642_titan(mdict):
    """
    Add/adjust metadata specific to the 642 FEI Titan ('***REMOVED*** in
...
def parse_642_jeol(mdict):
    """
    Add/adjust metadata specific to the 642 FEI Titan ('***REMOVED***
    in ***REMOVED***') to the metadata dictionary
