...
def oned_signals():
    ...
    sig_to_thumbnail(threed_s, '/home/***REMOVED***/tmp/4-3dSI.png', dpi=300)


def twod_signals():
    s = hs.load('/home/***REMOVED***/tmp/diffraction.dm3')
    print('2D: Diffraction pattern')
    sig_to_thumbnail(s, '/home/***REMOVED***/tmp/5-diffraction.png', dpi=300)

    s2 = hs.load('/home/***REMOVED***/tmp/darkfield image.dm3')
    print('2D: Image')
    sig_to_thumbnail(s2, '/home/***REMOVED***/tmp/6-DF_image.png', dpi=300)
    ...
    sig_to_thumbnail(s3, '/home/***REMOVED***/tmp/7-image_series.png', dpi=300)

    s4 = hs.load('/home/***REMOVED***/tmp/4d_stem.hdf5')
    print('2D: Hyperimage')
    sig_to_thumbnail(s4.inav[:,:], '/home/***REMOVED***/tmp/8-hyperimage.png', dpi=300)
...
def other_signals():
    ...
    sig_to_thumbnail(s, '/home/***REMOVED***/tmp/9-more_dimensions.png', dpi=300)
