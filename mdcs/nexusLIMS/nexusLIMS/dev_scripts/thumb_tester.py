...
def oned_signals():
    ...
    sig_to_thumbnail(s, f'/home/***REMOVED***/tmp/1-spectrum{extension}', dpi=dpi)

    oned_s = hs.stack([s * i for i in np.arange(.1, 1, .1)],
                      new_axis_name='x')
    oned_s.metadata.General.title = 'Dummy line scan'
    print('1D: Line scan')
    sig_to_thumbnail(oned_s, f'/home/***REMOVED***/tmp/2-linescan{extension}', dpi=dpi)

    s3 = hs.load('/home/***REMOVED***/tmp/EELS_SI.hdf5')
    s3.metadata.General.title = 'Example spectrum image'
    print('1D: Spectrum image (2d)')
    sig_to_thumbnail(s3, f'/home/***REMOVED***/tmp/3-2dSI{extension}', dpi=dpi)
    ...
    sig_to_thumbnail(threed_s, f'/home/***REMOVED***/tmp/4-3dSI{extension}', dpi=dpi)


def twod_signals():
    s = hs.load('/home/***REMOVED***/tmp/diffraction.dm3')
    print('2D: Diffraction pattern')
    sig_to_thumbnail(s, f'/home/***REMOVED***/tmp/5-diffraction{extension}', dpi=dpi)

    s2 = hs.load('/home/***REMOVED***/tmp/darkfield image.dm3')
    print('2D: Image')
    sig_to_thumbnail(s2, f'/home/***REMOVED***/tmp/6-DF_image{extension}', dpi=dpi)

    s3 = hs.load('/home/***REMOVED***/tmp/through_focal_series_ex.dm3')
    s3.metadata.General.title = "Through Focal Series"
    print('2D: Image stack')
    sig_to_thumbnail(s3, f'/home/***REMOVED***/tmp/7-image_series{extension}', dpi=dpi)

    s4 = hs.load('/home/***REMOVED***/tmp/4d_stem.hdf5')
    print('2D: Hyperimage')
    sig_to_thumbnail(s4.inav[:, :], f'/home/***REMOVED***/tmp/8-hyperimage{extension}',
                     dpi=dpi)
...
def other_signals():
    ...
    sig_to_thumbnail(s, f'/home/***REMOVED***/tmp/9-more_dimensions{extension}', dpi=dpi)
...
def survey_image():
    ...
    fname = os.path.join(_mmf_path,
                         'Titan/***REMOVED***/111418 Inspection A1 35nm Si membrane '
                         'US100_C35Q33 lot2266/11418 Inspection A1 35nm Si '
                         'membUS100_C35Q33 l2266CL130mmx160k STEMEELS SI21 '
